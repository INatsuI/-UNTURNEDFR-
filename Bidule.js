...
bot.on("ready", function() {
    bot.user.setActivity(`UFR Aide | BY @Edωɨה#5292 [V 3.1]`)
...
bot.on("message", message => {
    if(message.content.startsWith(prefix + "aide") || message.content.startsWith(prefix + "Aide")) {
        ...
        .setDescription("__**UNTURNED FR**__ : \n" +
            ...
            " `UFR Give` : *@Qui? @Role?.* \n" +
            " `UFR Groupe` : *Te donne le groupe d'Unturned FR.* \n" +
            " `UFR Say` : *Pour que le bot parle a votre place [COMMANDE ADMIN !].* \n" )
